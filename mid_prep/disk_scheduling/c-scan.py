...
def c_scan_v1(request_sequence, head):
    current_head = head
    sequence = []
    seek_count = 0

    request_sequence.sort()
    left =[seq for seq in request_sequence if seq < current_head]
    right =[seq for seq in request_sequence if seq >= current_head]
...
if __name__ == '__main__':
    ...
    head = 53
    res = c_scan_v1(req_sequences, head)
